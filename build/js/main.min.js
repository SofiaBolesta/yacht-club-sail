...
var initGallerySwiper = function initGallerySwiper() {
  if (gallerySwiper) {
    (function () {
      return new _swiper.default('.gallery__swiper', {
...
},{"../js/vendor/swiper.js":14}],2:[function(require,module,exports){
"use strict";
...
var _swiperPromo = require("./swiper-promo");
var _galleryVideoSwiper = require("./gallery-video-swiper");
window.addEventListener('DOMContentLoaded', function () {
  (0, _iosVhFix.iosVhFix)();
  (0, _swiperPromo.initPromoSwiper)();
  (0, _galleryVideoSwiper.initGallerySwiper)();
...
},{"./gallery-video-swiper":1,"./modules/form-validate/form":4,"./swiper-promo":10,"./utils/ios-vh-fix":12,"./vendor/iphone-inline-video":13,"./vendor/swiper":14}],3:[function(require,module,exports){
"use strict";
...
exports.initPromoSwiper = void 0;
var _swiper = _interopRequireDefault(require("../js/vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var promoSwiper = document.querySelector('.promo__swiper');
var initPromoSwiper = function initPromoSwiper() {
  if (promoSwiper) {
    (function () {
      return new _swiper.default('.promo__swiper', {
        direction: 'horizontal',
        loop: true,
        navigation: {
...
exports.initPromoSwiper = initPromoSwiper;

},{"../js/vendor/swiper.js":14}],11:[function(require,module,exports){
"use strict";
